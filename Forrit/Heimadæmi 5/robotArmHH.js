...
/////////////////////////////////////////////////////////////////
var NumVertices = 42; //(8 faces)(2 triangles/face)(4 vertices/triangle)
...
var END_PLATE_HEIGHT = 5.0;
var END_PLATE_WIDTH  = 0.5;
     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 65:	// a - snýr neðri armi
			    theta[1] = Math.min(90, theta[1]+5);
                break;
            case 83:	// s - snýr neðri armi
			    theta[1] = Math.max(-90, theta[1]-5);
                break;
            ...
            case 87:	// w - snýr efri armi
                ...
                break;
            case 69:	// e - snýr enda platta
			    theta[3] = Math.min(170, theta[3]+5);
                break;
            case 82:	// w - snýr enda platta
...
function endPlate()
{
    var s =scalem(END_PLATE_WIDTH, END_PLATE_HEIGHT, END_PLATE_WIDTH);
    var instanceMatrix = mult(translate( 0.0, 0.5 * END_PLATE_HEIGHT, 0.0 ), s);
    var t = mult(modelViewMatrix, instanceMatrix);
    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t) );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );
}
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, translate(0.0, END_PLATE_HEIGHT, 0.0));
    modelViewMatrix  = mult(modelViewMatrix, rotateZ( theta[EndPlate] ));
    endPlate();

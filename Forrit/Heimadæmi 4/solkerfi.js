    ...
    window.addEventListener("keydown", function(e){
        switch( e.keyCode ) {
            ...
            case 40:	// down arrow
                ...
                break;
            case 37: // left arrow
                disEarth = Math.max(0.85, disEarth - disEarthInc);
                break;
            case 39: // right arrow
                disEarth = Math.min(2.0, disEarth + disEarthInc);
                break;
        }
    } );
...
function render()
{
    ...
    rotDay += rotDayInc;
    rotYear += rotYearInc;        // not the correct value, but looks better!
    ...
    mv = mult( mv, translate( disEarth, 0.0, 0.0 ) );
